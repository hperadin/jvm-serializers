 ...
 return false; }
	...
	void __serializeJsonObjectFull(final com.dslplatform.client.json.JsonWriter sw, final boolean hasWrittenProperty) {
        ...
        if (this.images.size() != 0) {
            ...
            sw.writeAscii(",\"images\":[]", 12);
        }
	}

    public static com.dslplatform.client.json.JsonReader.ReadJsonObject<MediaContent> JSON_READER =
            new com.dslplatform.client.json.JsonReader.ReadJsonObject<MediaContent>() {
                @Override
                ...
                switch (nameHash) {
					...
					case -56959229:
                        ...
                        if (nextToken == '{') {
                            reader.getNextToken();
                            _media_ =
                                    serializers.dslplatform.media.Media.JSON_READER
                                            .deserialize(reader, _serviceLocator);
                            nextToken = reader.getNextToken();
                        } else {
