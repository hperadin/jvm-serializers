...
public final class Image implements java.io.Serializable, com.dslplatform.client.json.JsonObject {
	...
	void __serializeJsonObjectFull(final com.dslplatform.client.json.JsonWriter sw, final boolean hasWrittenProperty) {
        ...
        sw.writeAscii(",\"size\":\"SMALL\"", 9);
		sw.writeAscii(this.size.name());
		sw.writeByte(com.dslplatform.client.json.JsonWriter.QUOTE);
	}

    public static com.dslplatform.client.json.JsonReader.ReadJsonObject<Image> JSON_READER =
            new com.dslplatform.client.json.JsonReader.ReadJsonObject<Image>() {
                @Override
